 ...
 //untuk, ketika di halaman di load atau di refresh, jika browser mendukung storage maka jallankan yang lain
 window.addEventListener('load', function () {
  ...
  mengonfigurasi semua nilai dari item-item session storage kembali ke nilai awal. Sehingga, jika user 
  melakukan proses refresh/reload halaman, permainan yang belum selesai akan dihapus. Jika user ingin bermain 
  lagi, ia harus menekan tombol "Bermain".*/
